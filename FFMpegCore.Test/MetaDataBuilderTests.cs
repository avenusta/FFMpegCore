...
public class MetaDataBuilderTests
{
    ...
    public void Builder_AddChapter_ByDuration_ChainsFromPreviousEnd()
    {
        var metaData = new MetaDataBuilder()
            ...
            .AddChapter(new ChapterData { Title = "Explicit", Start = TimeSpan.FromSeconds(100), End = TimeSpan.FromSeconds(110) })
            .Build();
    ...
    {
        var serialized = MetaDataSerializer.Instance.Serialize(new MetaDataBuilder()
            .AddChapter(new ChapterData { Title = "", Start = TimeSpan.FromSeconds(1.5), End = TimeSpan.FromSeconds(3) })
            .Build());
    ...
    public void MetaData_CloneConstructor_CopiesEntriesAndChapters()
    {
        ...
        original.Chapters.Add(new ChapterData { Title = "One", Start = TimeSpan.Zero, End = TimeSpan.FromSeconds(1) });
